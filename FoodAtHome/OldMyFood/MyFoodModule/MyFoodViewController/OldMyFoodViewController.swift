...
class OldMyFoodViewController: UIViewController {

    let localRealm = FoodManager.shared.getRealm()
    var presenter: OldMyFoodPresenterProtocol!
    private let configurator: OldMyFoodConfiguratorProtocol = OldMyFoodConfigurator()
...
extension OldMyFoodViewController {
...
extension OldMyFoodViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension OldMyFoodViewController: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension OldMyFoodViewController: OldMyFoodViewProtocol {
    func reloadData() {
        self.myFoodCollectionView.reloadData()
...
extension OldMyFoodViewController: AddAndChangeFoodDelegate {
