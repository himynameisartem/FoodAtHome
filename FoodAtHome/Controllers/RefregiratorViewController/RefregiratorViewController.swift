//
//  RefregiratorViewController.swift
//  FoodAtHome
//
...
class RefregiratorViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row != test.count {
            ...
            if test[indexPath.row].expirationDate != nil {
            if differenceOfDays <= 2 && differenceOfDays > 0  {
                ...
                cell.attentionView.isHidden = true
            }
...
extension RefregiratorViewController: UIPickerViewDelegate, UIPickerViewDataSource {
...
extension RefregiratorViewController {
    ...
    extension RefregiratorViewController {
        ...
        func popOverMunuView(view: UIView, indexPath: IndexPath, popover: Popover) {
            ...
            if  let toDate = test[indexPath.row].expirationDate {
                ...
                if let fromDate = test[indexPath.row].productionDate{
